# Laravel Boilerplate (PHP-FPM + Nginx TCP + PostgreSQL + Redis)
...
*   **Высокая производительность:** Связь между Nginx и PHP-FPM реализована через **TCP (порт 9000)**, что обеспечивает стабильную и простую работу в Docker-окружении без необходимости шарить файловую систему.
*   **Современный стек:**
